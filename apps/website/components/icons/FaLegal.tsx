...
export default function FaLegal(props?: ComponentProps<"svg">) {
    return (
        <svg {...props} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="gavel" className={"svg-inline--fa fa-gavel " + (props?.className ?? "")} role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
