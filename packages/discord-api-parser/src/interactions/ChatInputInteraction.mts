...
export class AttachmentOption extends BaseOption {
    ...
    constructor(name: string, id: string, attachment: APIAttachment) {
...
export function formatOption(option: APIApplicationCommandInteractionDataOption, resolved: APIInteractionDataResolved | undefined, guildId?: string): Options {
