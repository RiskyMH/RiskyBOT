 ...
 */
export function userMention<UserId extends string>(userId: UserId): `<@${UserId}>` {
    return `<@${userId}>`;
}
 ...
 */
export function channelMention<ChannelId extends string>(channelId: ChannelId): `<#${ChannelId}>` {
    return `<#${channelId}>`;
}
 ...
 * @param commandId - The application command id to format
 */
export function chatInputApplicationCommandMention<CommandName extends string, CommandId extends string>(
    commandName: CommandName,
    commandId: CommandId,
...
export function chatInputApplicationCommandMention<
    CommandName extends string,
    SubcommandGroupName extends string | string,
    SubcommandName extends string | string,
    CommandId extends string,
>(
    commandName: CommandName,
    subcommandGroupName: SubcommandGroupName,
 ...
 */
export function formatEmoji<EmojiId extends string>(emojiId: EmojiId, animated?: false): `<:_:${EmojiId}>`;
 ...
 */
export function formatEmoji<EmojiId extends string>(emojiId: EmojiId, animated?: true): `<a:_:${EmojiId}>`;
 ...
 * @param animated - Whether the emoji is animated
 */
export function formatEmoji<EmojiId extends string>(
    emojiId: EmojiId,
    animated?: boolean,
 ...
 */
export function channelLink<ChannelId extends string>(
    channelId: ChannelId,
 ...
 */
export function channelLink<ChannelId extends string, GuildId extends string>(
    channelId: ChannelId,
    guildId: GuildId,
 ...
 */
export function messageLink<ChannelId extends string, MessageId extends string>(
    channelId: ChannelId,
    messageId: MessageId,
 ...
 * @param guildId - The guild's id
 */
export function messageLink<ChannelId extends string, MessageId extends string, GuildId extends string>(
    channelId: ChannelId,
    messageId: MessageId,
    guildId: GuildId,
